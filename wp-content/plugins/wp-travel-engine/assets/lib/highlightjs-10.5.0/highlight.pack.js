...
skip:!0})]}]})})());hljs.registerLanguage("json",(()=>{"use strict";return n=>{const e={
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
