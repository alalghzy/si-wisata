...
?>
<div data-thumbnail="default" class="category-trips-single<?php echo $is_featured ? ' __featured-trip' : ''; echo $new_trip_listing ? ' wpte_new-layout' : ''; ?>" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
		...
		<div class="category-trip-content-wrap">
			<div class="category-trip-prc-title-wrap">
				...
				?>
					...
					<a class="wishlist-toggle<?php echo esc_attr( $active_class ); ?>" data-product="<?php echo esc_attr($post->ID); ?>" title="<?php echo __( $title_attribute, 'wp-travel-engine' ); ?>">
			...
			<div class="category-trip-detail-wrap">
				<div class="category-trip-prc-wrap">
					...
					<div class="category-trip-budget">
						...
						if ($show_date_layout && $fsds && is_array($fsds)) { ?>
						...
						<?php }
						if(  $show_date_layout  && ( empty( $fsds ) || is_numeric( $fsds) ) ){
				...
				<?php if ( ( isset( $settings['display_new_trip_listing'] ) &&  'yes' !== $settings['display_new_trip_listing'] && $show_excerpt ) || !$show_date_layout) :?>
					<div class="category-trip-desc">
						<?php wptravelengine_the_trip_excerpt(); ?>
					</div>
				<?php endif; ?>
			...
			if ($fsds == get_the_ID() || empty($fsds)) {
				if( ( !isset( $settings['display_new_trip_listing'] ) || ( $new_date_layout ) ) ):?>
					<div class="category-trip-avl-tip-inner-wrap<?php echo (!$show_available_months) ? '' : ' new-layout'; ?>">
						<span class="category-available-trip-text"><?php echo __('Available through out the year:', 'wp-travel-engine');?></span>
